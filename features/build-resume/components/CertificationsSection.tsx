        ...
        <div className="w-full xl:w-72 xl:flex-shrink-0">
          <div className="sticky top-6 rounded-lg bg-matte-dark p-3">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="mb-2 text-sm font-medium text-white">Certifications Tips</h4>
                <ul className="space-y-1 text-xs text-gray-300">
                  <li>• Include professional certifications</li>
                  <li>• Add industry certs (AWS, PMP, etc.)</li>
                  <li>• Include language certs if relevant</li>
                  <li>• List technical certifications</li>
                  <li>• Include expiration dates</li>
                  <li>• Only include valuable certs</li>
                </ul>
              </div>
            </div>
          </div>
