...
export interface SkillsSectionRef {
  saveData: () => void
  hasUnsavedChanges: boolean
}

const SkillsSection = forwardRef<SkillsSectionRef, SkillsSectionProps>(
  ({ data, onChange, onSave }, ref) => {
    ...
    // Expose saveData function to parent
    useImperativeHandle(
      ref,
      () => ({
        saveData,
          ...
          <div className="mb-8 text-center">
            ...
            <div className="mt-4 rounded-lg border border-chatgpt-accent/30 bg-chatgpt-accent/10 p-4">
              <p className="text-sm text-chatgpt-accent">
                💡 <strong>Tip:</strong> Check the "Include in Resume" box for each skill category
                you want to appear in your final resume
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-sm text-gray-300">
                    ...
                    <li>
                      • Languages: Include proficiency levels (Native, Fluent, Conversational,
                      Basic)
                    </li>
                    ...
                    <li>
                      • Select text and click the bold button (B) to highlight important skills
                    </li>
                  </ul>
                </div>
              </div>
