        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <button
              onClick={downloadPNG}
              disabled={isGenerating || !userName.trim()}
              className="flex-1 rounded-lg bg-gradient-to-r from-primary to-primary-600 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:from-primary-600 hover:to-primary-700 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        <div className="overflow-hidden rounded-2xl shadow-2xl">
          ...
          >
            ...
            <div className="absolute left-0 top-0 flex h-full w-[25%] flex-col items-center justify-center bg-[#1a1a1a] text-white">
              ...
              <h3 className="text-center text-xl font-bold tracking-wide">Tough Tongue AI</h3>
            </div>
