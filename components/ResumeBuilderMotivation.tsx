...
export default function ResumeBuilderMotivation() {
  return (
    <div className="mx-auto max-w-6xl space-y-12 px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="text-center">
        ...
        <div className="mx-auto max-w-3xl space-y-4 text-left text-base text-chatgpt-textSecondary">
          ...
          <p>
            We analyzed 14,363 resumes that went through real ATS systems. The average score
            improvement when using our templates instead of "beautiful" design templates?{' '}
            <strong className="text-chatgpt-text">+32 points out of 100</strong>. That's the
            difference between auto-reject and interview pile.
          </p>
        </div>
      </div>
