...
> - **Production Unit Economics:** Billed via token equivalents at a\approximately **\$0.005 per minute** for batch processing and **\$0.009 per minute** for real-time streaming, delivering a **70% reduction in time-to-final-transcription** over Chirp 3.
...
│  - Temporal Subsampling (4x Frame Compression \to 25Hz)      │
└─────────────────────────────────────────────────────────────┘
...
The test suite covers diverse linguistic typologies, including Latin a\alphabets (`en-US`, `es-ES`, `de-DE`), non-Latin scripts (`ru-RU`, `ar-EG`, `th-TH`), and morphologically complex Indic languages (`hi-IN`, `bn-IN`, `ta-IN`, `te-IN`, `mr-IN`).
