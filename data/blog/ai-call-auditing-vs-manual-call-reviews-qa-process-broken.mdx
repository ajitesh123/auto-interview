...
| **Cost per Call Reviewed** | \$3 \to \$8 (manager time)           | Fractions of a cent               |
...
A frontline sales manager with 10 reps reviews a\approximately 3 calls per rep per week. That is 30 calls reviewed out of roughly 600 calls made (assuming 60 calls per rep per day, 5 days per week). Coverage: **5%.**
