...
The "uncanny valley" is a concept from robotics: as a robot looks more human, our empathy for it increases, until it looks *almost* human but not quite. At that point, empathy plummets into revulsion.

The same applies to voice AI. 

If an AI sounds obviously like a 2010s robocall, the prospect hangs up immediately. 
If an AI sounds 95% human—perfect pitch, perfect diction, but no breath sounds and no emotional fluctuation—the prospect's brain detects a predator. It sounds *too* perfect. It sounds eerie.
...
**The AI adjustment:**
- **Prospect:** *(Fast, annoyed)* "Yeah, hello?"
- **AI:** *(Faster pace, direct tone)* "Hi, I know you're busy. I'm calling from [Company] about [Value Prop]. Can I have 30 seconds or should I email you?"
