...
│    - Emits \partial \text tokens every 40ms \to 60ms                      │
└────────────────────────────────────────────────────────────────────────┘
```
...
The forward-backward dynamic programming variable $\alpha_t(s)$ computes path probabilities in linear time $\mathcal{O}(T \cdot U)$:

$$
\alpha_t(s) = \left[\alpha_{t-1}(s) + \alpha_{t-1}(s-1)
\right] P(y'_s \mid \mathbf{x}_t)
$$
...
│    - Streams first generated response words directly \to voice vocoder  │
└────────────────────────────────────────────────────────────────────────┘
```
...
│    - Converts \text characters into phonetic pronunciations and pitch   │
└────────────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌────────────────────────────────────────────────────────────────────────┐
...
[Audio Egress RTP Packetization] ──► [WebRTC Output Stream \to User]
```
...
$$
\text{Attention}(\mathbf{Q}, \mathbf{K}, \mathbf{V}) = \text{softmax}\left(\frac{\mathbf{Q}\mathbf{K}^T}{\sqrt{d_k}}
\right)\mathbf{V}
$$
