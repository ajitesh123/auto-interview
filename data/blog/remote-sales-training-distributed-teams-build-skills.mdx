...
**Structure:** 20-minute RAPID coaching sessions 2 to 3 \times per week via video call.
...
- Rotate session \times monthly so the same region is not always disadvantaged
