...
A caller says "I run a chain of three res\taurants in Pune" early in a conversation. Five minutes later, they ask "Which plan would work for my type of business?" An agent with memory connects the dots. An agent without memory asks "What kind of business do you run?" — and the caller loses patience.
...
Beyond remembering _callers_, agents also need to remember _information_ — product details, pricing, policies, procedures, and domain knowledge.
...
```
Call 1:
Caller: "I run three res\taurants \in Pune."
Agent: "Great! Let me tell you about our plans..."
[10-minute conversation about res\taurant-specific features]
...
Caller: [frustrated] "I already told you. Res\taurants. In Pune."
```
...
Agent: "Welcome back! Last time we discussed the Enterprise plan
        for your three res\taurant locations \in Pune. You mentioned
        wanting \to integrate with your existing POS system. Have
        you had a chance \to think about that?"
...
What happens when stored information becomes outdated? A caller who said "I have three res\taurants" six months ago might now have five. The memory system needs a way to update and override stale information — not just accumulate.
...
This is particularly powerful for use cases like **lead qualification and follow-up**, where the same lead might interact with the system multiple \times over days or weeks.
