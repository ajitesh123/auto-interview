...
canonicalUrl: 'https://www.toughtongueai.com/blog/ai-calling-mistakes-that-kill-pipeline-how-to-avoid-2026'
structuredData:
  ...
  '@graph':
    - '@type': 'Article'
      ...
      mainEntityOfPage:
        '@type': 'WebPage'
        '@id': 'https://www.toughtongueai.com/blog/ai-calling-mistakes-that-kill-pipeline-how-to-avoid-2026'
    - '@type': 'FAQPage'
      mainEntity:
        - '@type': 'Question'
