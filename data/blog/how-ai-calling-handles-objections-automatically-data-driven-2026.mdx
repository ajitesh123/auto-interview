    ...
    - '@type': 'FAQPage'
      mainEntity:
        ...
        - '@type': 'Question'
          ...
          acceptedAnswer:
            '@type': 'Answer'
            text: 'AI handles the "too busy" objection by validating the prospect''s time and pivoting immediately to the core value proposition. Example: "I completely understand, I''l be brief. I''m just calling because we helped [Competitor] solve [Pain Point]. Does that sound like a priority for your team ight now?"'
---
...
If an AI just ignores the objection and continues pitching, it triggers the "uncanny valley" and the prospect hangs up. The AI must prove it _heard_ the objection before moving forward.
...
flowchart TD
    ...
    B -->|Send Email| D[Agree \to Send Info]
    ...
    K --> L[Pass Conversational Turn Back \to Prospect]
...
1. Agree \to send the email.
2. Pivot \to a qualifying question \to "customize" the email.
```
...
_"If the prospect asks a question you do not have the answer to, or becomes frustrated, you MUST say: 'That is a great question that is a bit outside my expertise. Let me grab a senior account executive to answer that for you \right now, please hold for one second.' Then trigger the handoff API."_
