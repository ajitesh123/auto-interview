...
Voiced speech produces distinct harmonic peaks ($F_0, F_1, F_2$), resulting in low spectral flatness ($\gamma_m \a\approx 0$).

Unvoiced background noise distributes energy evenly across all frequencies, resulting in high spectral flatness ($\gamma_m \a\approx 1$).
