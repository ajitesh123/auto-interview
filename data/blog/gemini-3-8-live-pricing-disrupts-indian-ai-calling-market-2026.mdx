...
structuredData:
  ...
  '@graph':
    ...
    - '@type': 'FAQPage'
      mainEntity:
        - '@type': 'Question'
          name: 'What is the total turnkey cost per minute for Gemini 3.8 Live in India?'
          acceptedAnswer:
            '@type': 'Answer'
            text: 'The all-in cost is approximately ₹2.38 per minute, combining Gemini 3.8 Live model usage (₹1.73/min blended), Indian PSTN SIP trunking (₹0.45/min), and WebRTC session management (₹0.20/min).'
        - '@type': 'Question'
          name: 'Is Gemini 3.8 Live cheaper than human tele-callers in India?'
          acceptedAnswer:
            '@type': 'Answer'
            text: 'Yes. At ₹2.38 per minute, Gemini 3.8 Live is 32% to 52% cheaper than human BPO callers who cost ₹3.50 to ₹5.00 per productive connected minute.'
        - '@type': 'Question'
          name: 'How does Gemini 3.8 Live handle Indian languages and Hinglish code-switching?'
          acceptedAnswer:
            '@type': 'Answer'
            text: 'Gemini 3.8 Live natively supports 97+ languages with real-time mid-sentence code-switching between Hindi, English, Tamil, Telugu, and other regional dialects.'
---
...
══════════════════════════════════════════════════════════════════════════
- Total All-In Turnkey Production Cost: ₹2.38 per connected minute
