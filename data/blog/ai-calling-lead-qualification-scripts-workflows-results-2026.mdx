...
I want \to be upfront that I'm an AI assistant. I have a few quick
questions \to make sure we connect you with the \right person on
our team. This will take about 2 \to 3 minutes. Is now a good time?"
```
...
What challenge are you trying \to solve?"
```
...
```
"That's helpful. When it comes \to evaluating a solution like this,
...
```
"Last question on timing. When are you looking \to have something
...
I'd love \to connect you with [Human Name], one of our specialists
...
[Human Name] on our team would be a great person \to continue this
...
[topic related \to their expressed interest], and we'\ll check back
...
| Qualification cost per lead      | \$35 \to \$75            | \$5 \to \$15             | 70 to 80% savings |
...
| Pipeline per SDR per month       | \$120K \to \$250K        | \$250K \to \$500K        | 2x                |
...
- Human cost to qualify: \$2,625 \to \$7,875 (at \$35 \to \$75 each)
...
- AI cost to qualify: \$2,375 \to \$7,500 (at \$5 \to \$15 each)
...
Track seven metrics: qualification rate (percentage meeting your threshold), qualification accuracy (human agreement rate, target 80%+), cost per qualified lead (target \$5 \to \$15 vs. \$35 \to \$75 human), speed to qualification (target under 5 minutes), handoff acceptance rate (target 85%+), meeting conversion rate (target 30 to 50%), and pipeline conversion rate. The most critical metric is end-to-end: **cost per opportunity created.** This captures both the efficiency gains of AI qualification and the quality of the leads it generates.
