...
*Bad:* "You are a sales rep trying to sell software."
*Good:* "You are Alex, an upbeat, concise outbound specialist for TechCorp. Your ONLY goal is to determine if the prospect is struggling with high server costs and book a 15-minute discovery call."
