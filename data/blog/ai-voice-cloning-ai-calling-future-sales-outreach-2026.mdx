    ...
    - '@type': 'FAQPage'
      mainEntity:
        ...
        - '@type': 'Question'
          ...
          acceptedAnswer:
            '@type': 'Answer'
            text: 'AI voice cloning costs vary by platform and usage volume. Voice cloning setup typically costs between \$0 and \$500 for initial model creation. Per-minute calling costs range from \$0.05 o \$0.25 depending on the platform and volume tier. For a team making 1,000 calls per day averaging 3 minutes each, monthly calling costs range from \$4,500 o \$22,500. Compared to the cost of hiring equivalent SDRs (approximately \$5,000 o \$7,000 per month per rep), AI voice cloning delivers 5x to 10x more conversations at 30 to 60% lower cost.'
        - '@type': 'Question'
...
| --------------------------- | -------------------------- | ---------------------------------- |
| **Monthly cost**            | \$35,000 \to \$50,000      | \$5,000 \to \$12,000               |
| **Daily call capacity**     | 300 calls                  | 3,000+ calls                       |
| **Monthly conversations**   | 6,000                      | 60,000+                            |
| **Cost per conversation**   | \$5.83 \to \$8.33          | \$0.08 \to \$0.20                  |
