...
```json
{
  ...
  "stt": {
    "transcript": "I want \to know about your pricing plans",
    "latency_ms": 180,
...
- [Turn Detection Explained: Fix Robotic Voice AI](/blog/turn-detection-adaptive-interruption-handling-voice-ai-2026)
