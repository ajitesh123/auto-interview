...
keywords: 'behavioral interview questions, STAR method examples, interview storytelling, AI mock interview practice'
images:
...
- **Action (~60%)**  
  Tell the interviewer what _you_ did. Use chronological steps, decisive verbs, and “I” statements to highlight ownership.
- **Result (~10%)**  
...
- Behavioral questions test _proof_ - answer with structured stories and metrics.
