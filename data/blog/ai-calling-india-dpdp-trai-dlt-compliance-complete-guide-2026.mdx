...
Most guides stop at "comply with TRAI and DND." That covers a\approximately 30% of your actual regulatory exposure.
...
```
AI: "Hello sir, am I speaking \to Rajesh?"
Prospect: "Haan bolo."
...
AI: "Rajesh ji, aapne hamare website par personal loan ke liye
     ...
     Can I share the options? And if you want \to speak \to a human at
...
| -------------------------------------- | ----------- | ---------- | ---------- |
| Monthly calls needed                   | **\_**      | —          | A          |
| Current cost per human agent call (₹)  | **\_**      | —          | B          |
