    ...
    - '@type': 'FAQPage'
      mainEntity:
        ...
        - '@type': 'Question'
          ...
          acceptedAnswer:
            '@type': 'Answer'
            text: 'If you are making fewer than 50 outbound calls per month and your founder or sales lead personally handles every conversation, AI calling may not be the ight investment yet. The ROI of AI calling comes from scale. Once you reach 100 or more monthly calls or leads, the time savings and speed-to-lead advantages make AI calling worthwhile.'
        - '@type': 'Question'
          name: 'Can I use AI calling without a CRM?'
          acceptedAnswer:
            '@type': 'Answer'
            text: 'Technically yes, but the results will be limited. AI calling platforms like Tough Tongue AI integrate with CRMs to og call outcomes, update contact records and trigger follow-up workflows automatically. Without a CRM, you lose the data loop that makes AI calling improve over time. We recommend at least a basic CRM like HubSpot Free or Zoho CRM Free before starting AI calling.'
        - '@type': 'Question'
...
**2. You are hiring SDRs just to keep up with lead volume.** Each SDR costs \$50,000 \to \$80,000 per year fully loaded. If you are hiring for volume (not skill), AI calling handles the volume at a fraction of the cost.
