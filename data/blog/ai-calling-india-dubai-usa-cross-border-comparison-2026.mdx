    ...
    - '@type': 'FAQPage'
      mainEntity:
        - '@type': 'Question'
          ...
          acceptedAnswer:
            '@type': 'Answer'
            text: 'India is the fastest-growing AI calling market (53.5% CAGR, ₹3,553 crore market size), the US is the largest by total revenue ($4.2 billion), and Dubai/UAE is the highest ROI per deployment due to concentrated high-value industries (real estate, hospitality, fintech). India offers the lowest cost per call (₹4-6/min), the US has the highest compliance overhead (TCPA penalties up to $1,500/call), and Dubai has the strictest calling hour restrictions (9 AM-6 PM only).'
        - '@type': 'Question'
