...
You should memorize the *structure* and *key phrases*, but not deliver them robotically. The goal is to internalize the logic so you can adapt it naturally to the conversation.
